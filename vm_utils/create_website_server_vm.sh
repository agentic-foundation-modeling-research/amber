...
INSTANCE_TYPE="e2-custom-24-32768"
...
echo "Creating instance '$INSTANCE_NAME' ($INSTANCE_TYPE, 700GB SSD, ubuntu-2204-lts, tags: $SSH_FW_NAME,$HTTP_FW_NAME)"
...
gcloud compute instances create "$INSTANCE_NAME" \
    ...
    --tags="$SSH_FW_NAME","$HTTP_FW_NAME" \
    --boot-disk-size=700GB \
